...
public class ResetPrizeV3 : MonoBehaviour
{
    ...
    public void Reset()
    {
        if ((c.GetCraneType() != 8 && (c.craneStatus == 0 || c.craneStatus == 1)) || (c.GetCraneType() == 8 && (c.craneStatus >= 0 && c.craneStatus <= 2)))
        {
